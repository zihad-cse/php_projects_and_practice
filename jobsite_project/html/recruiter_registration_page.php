                        ...
                        <form action="" method="post">
                            ...
                            <div class="col-12 row p-3">
                                ...
                                <div class="col-4">
                                    ...
                                    <input id="passRepeat" type="text" name="passConfirm" class="form-control">
                                </div>
                            </div>
                            <hr class="m-0">
                            <div class="col-12 row p-3">
                            ...
                            <div class="col-12 row p-3">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <select class="form-select mt-3" name="companyAddDistrict"
                                                id="companyAddDistrict">
                                        ...
                                        <div class="col-6">
                                            <select class="form-select mt-3" name="companyAddThana"
                                                id="companyAddThana">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <textarea class="mt-3 form-control" style="resize: none;"
                                                name="companyAddDetails" id="companyAddDetails" cols="30" rows="10"
                                                placeholder="Write company address *"></textarea>
                                        </div>
                                        <div class="col-6">
                                            <textarea class="mt-3 form-control" style="resize: none;"
                                                name="companyAddDetailsBD" id="companyAddDetailsBD" cols="30" rows="10"
                                                placeholder="Write company address in Bangla"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
